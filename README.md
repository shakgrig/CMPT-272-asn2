...
| Effort, Creativity and Usability (Error checking and learnability of the app, Style needs to be there) | **3 pts Full Marks 0 pts No Marks** | / 3 pts         |
...
<details hidden><summary></summary><style>code{color:red;}</style></details>
